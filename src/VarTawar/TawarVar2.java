 ...
 * @author user
 */
public class TawarVar2 extends BahandanHarga implements Filling {
    ...
    public void hitungTakaran(){
        tepung1 = (beratTepungTeriguM / takaran) * pesanTawarVar2;
        gula1 = (beratGulaPasirM / takaran) * pesanTawarVar2;
        butter1 = (beratButterM / takaran) * pesanTawarVar2;
        ragi1 = (beratRagiM / takaran) * pesanTawarVar2;
        sBubuk1 = (beratSusuBubukM / takaran) * pesanTawarVar2;
        sCair1 = (beratSusuCairM / takaran) * pesanTawarVar2;
        telur1 = (beratTelurM / takaran) * pesanTawarVar2;
        es1 = (beratEsBatuM / takaran) * pesanTawarVar2;
    }
    ...
    public void cetak(){
        int totalSemua = (int) (tepung2+gula2+butter2+ragi2+sBubuk2+sCair2+telur2+es2 + fillingKeju + hargaKj); 
        int hpp1 = (int) (totalSemua / pesanTawarVar2);
        int hpp2 = hpp1 + (hpp1 * 50/100);
        System.out.println("CETAK BAHAN ROTI Tawar Var2");
        System.out.println("----------------------------------------------------");
        ...
        System.out.println("HPP Roti Tawar Var2     : Rp  " + hpp1);
